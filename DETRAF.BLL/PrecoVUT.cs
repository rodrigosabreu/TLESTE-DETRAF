...
{
    public sealed class PrecoVUT : Preco
    {
        public PrecoVUT() { }
            ...
            while (sLine != null)
            {
                ...
                if (!string.IsNullOrEmpty(sLine))
                {
                    ...
                    catch (Exception ex)
                    {
                        erro = true;
                        mensagem = ex.Message;
                        objLogger.Gravar(@"C:/detraf/tabelas/critica-tabelas.txt", sLine.ToString() + " - VUT - " + mensagem);
                    }
                }
            }
            return erro;
            ...
            while (sLine != null)
            {
                ...
                if (!string.IsNullOrEmpty(sLine))
                {
                    ...
                    try
                    {
                        ...
                        objPrecoDal.GravarVUT(Eot, ValorHorarioNormal, ValorHorarioReduzido);
