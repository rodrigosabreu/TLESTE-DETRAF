...
{
    public sealed class PrecoVUM : Preco
    {
        public PrecoVUM() { }
            ...
            while (sLine != null)
            {
                ...
                if (!string.IsNullOrEmpty(sLine))
                {
                    ...
                    catch (Exception ex)
                    {
                        erro = true;
                        mensagem = ex.Message;
                        objLogger.Gravar(@"C:/detraf/tabelas/critica-tabelas.txt", sLine.ToString() + " - VUM - " + mensagem);
                    }
                }
            }
            return erro;
            ...
            while (sLine != null)
            {
                ...
                if (!string.IsNullOrEmpty(sLine))
                {
                    ...
                    try
                    {
                        ...
                        objPrecoDal.GravarVUM(Eot, ValorHorarioNormal, ValorHorarioReduzido);
